...
/**
 * Specialized badge for displaying file modification status.
 * @param props The component properties.
 * @returns The rendered FileBadge component.
 */
...
/**
 * Component for displaying a single file item with an optional diff view.
 * @param props The component properties.
 * @returns The rendered FileItem component.
 */
 ...
 * @param props The component properties.
 * @returns The rendered CommitList component.
 */
