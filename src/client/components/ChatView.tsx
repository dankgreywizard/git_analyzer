...
/**
 * Component that displays the chat interface, including message history and input field.
 * @param props The component properties.
 * @returns The rendered ChatView component.
 */
const ChatView: React.FC<ChatViewProps> = ({
  ...
  /**
   * Effect to scroll the chat container to the bottom when messages change.
   */
  useEffect(() => {
