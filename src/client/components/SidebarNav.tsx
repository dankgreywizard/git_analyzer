 ...
 * @returns The rendered NavItem component.
 */
...
/**
 * Sidebar navigation component containing the application's primary navigation links.
 * @param props The component properties.
 * @returns The rendered SidebarNav component.
 */
